...
@Component({
  selector: 'etx-structures-operators',
  templateUrl: './structures-operators.component.html',
  styleUrls: ['./structures-operators.component.scss'],
})
export class StructuresOperatorsComponent implements OnInit {
  constructor() {}
  ...
  ngOnInit(): void {
    ...
    */
    ...
    const rest1: Rest = { name: 'Rest1', location: 'Craiova' };
    const rest2: Rest = { name: 'Rest1', country: 'Romania' };
